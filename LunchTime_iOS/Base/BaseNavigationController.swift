...
extension UIFont {
    ...
    @nonobjc
    static let at_profileTitle = UIFont.systemFont(ofSize: 23, weight: UIFont.Weight.light)

    @nonobjc
    static let at_title = UIFont.systemFont(ofSize: 18, weight: UIFont.Weight.light)
    
    @nonobjc
    static let at_placeholderLabel = UIFont.systemFont(ofSize: 16, weight: UIFont.Weight.light)
    
    @nonobjc
    static let at_details = UIFont.systemFont(ofSize: 15, weight: UIFont.Weight.light)
    
    @nonobjc
    static let at_subtitle = UIFont.systemFont(ofSize: 14, weight: UIFont.Weight.light)
    
    @nonobjc
    static let at_label = UIFont.systemFont(ofSize: 13, weight: UIFont.Weight.light)
